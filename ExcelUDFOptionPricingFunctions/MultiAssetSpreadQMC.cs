...
namespace CsOptionPricerAddIn
{
    public class MultiAssetSpreadQMC
    {
        ...
        public static object dnetMultiAssetSpreadQMC([ExcelArgument(Name = "OutPutFlag", Description = Flag.OutputFlag)] string OutPutFlag,
                               ...
                               [ExcelArgument(Name = "dS", Description = "Delta S")] double ds)
        {
            ...
            {
                result = OPLib.MultiAssetSpreadQMCMethod.SpreadOptionQMC(CallPutFlag, Wgt, S, X, T, r, b, v, mat, times);
            }
            else
            {
                result = double.NaN;
