...
namespace ExcelUDFOptionPricingFunctions
{
    public class StandardBarrierOptionAnalyticMethod
    {
        ...
        public static object dnetStandardBarrierNGreeks([ExcelArgument(Name = "OutPutFlag", Description = Flag.OutputFlag)] string OutPutFlag,
                                               ...
                                               [ExcelArgument(Name = "dS", Description = "Delta S")] double ds)
        {
            ...
            {
                result = (double)BlackScholesPricer.dnetGBlackScholesNGreeks(OutPutFlag, CallPutFlag, S, X, T, r, b, v, ds);
                return result;
            }
